	...
	public function add(){
		if($this->input->post('nama')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				//$id = $this->M_main->getKodeMaster("ortu","id_ortu","ortu");
				$data=array(
					...
					"id_wali_siswa"=>filter_string($this->input->post('wali',TRUE)),
				...
				$datalama = "";
				$databaru = $data['nis_siswa'].'<br>'.$data['nama_siswa'].'<br>'.$data['alamat_siswa'].'<br>'.$data['hp_siswa'].'<br>'.$data['jenkel_siswa'].'<br>'.$data['id_wali_siswa'].'<br>'.$data['id_akses_siswa'];
	...
	public function update(){
		if($this->input->post('id_')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$datalama = $row['nis_siswa'].'<br>'.$row['nama_siswa'].'<br>'.$row['alamat_siswa'].'<br>'.$row['hp_siswa'].'<br>'.$row['jenkel_siswa'].'<br>'.$row['id_wali_siswa'];
				$databaru = $update['nis_siswa'].'<br>'.$update['nama_siswa'].'<br>'.$update['alamat_siswa'].'<br>'.$update['hp_siswa'].'<br>'.$update['jenkel_siswa'].'<br>'.$update['id_wali_siswa'];
