<!-- Modal -->
<form class="cmxform form-horizontal" id="commentForm" method="post" action="<?php echo site_url('pelanggaran/delete'); ?>">
         ...
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    ...
                    <input type="hidden" value="<?php echo $row['id_pelanggaran']; ?>" name="id_">
                </div>
            </div>
            <div class="control-group ">
