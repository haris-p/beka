      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
			...
			<div class="control-group ">
                ...
                <div class="controls">
                    <select required data-placeholder="- Pilih Orangtua - " class="chzn-select-deselect span12" tabindex="-1" id="selCSI" name="wali">
                        <option value="">- Pilih Orangtua -</option>
                        <?php foreach ($ortu as $row) { ?>
                          <option value="<?php echo $row->id_ortu; ?>">
                            <?php echo $row->nama_ortu; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
