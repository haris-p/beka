<!-- Modal -->
<form class="cmxform form-horizontal" id="commentForm" method="post" action="<?php echo site_url('Ortu/delete'); ?>">
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    <label class="control-label" style="font-weight: bold;">: <?php echo $row['nama_ortu']; ?></label>
